...
const Footer = () => {
    ...
    if (status === 'unauthenticated') return <div className="footer w-full" />
    ...
    return (
        <div className="footer w-full">
            ...
            >
                ...
                <Link href={username ? `/${username}/workout` : '#'}>
                ...
                <Link href={username ? `/${username}/consumed/${moment().format('YYYY-MM-DD')}` : '#'}>
