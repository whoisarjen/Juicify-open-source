...
const DialogAddProducts = ({
    ...
    const [checked, setChecked] = useCache<(Product & { howMany?: number })[]>('CHECKED_PRODUCTS')
            ...
            >
                <Grid>
                    ...
                    {products.map(product => {
                        const isChecked = checked.some(x => x.id === product.id)
                        ...
                        return (
                            <BoxAddProduct
                                ...
                                onValueChange={howMany => {
                                    setLoadedProducts(state => state.map(currentProduct => {
                                    ...
                                    setChecked(checked.map(currentProduct => {
                                        if (currentProduct.id === product.id) {
                                            return {
                                                ...currentProduct,
                                                howMany,
